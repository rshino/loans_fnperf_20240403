...
#BY_AGE# #D_HIST# select "BY_AGE and D_HIST are incompatible switches, exiting.." as Message;
#BY_AGE# #D_HIST# exit
...
fnsf_origination
	where 1=1
      ...
      /*_F_TERM_ 
       and  _F_TERM_ = case when fnsf_origination.orig_term > 360 then 480
       when fnsf_origination.orig_term > 240 then 360
         when fnsf_origination.orig_term > 180 then 240
	   else 180 end
	_F_TERM_*/
...
##       /*_BY_BAL_	,bal_seg enum('VLOW','LOW','MED','HIGH','SUPER','0')  
##       			,max_bal decimal(16,2) unsigned
##       _BY_BAL_*/
##       /*_BY_BALP_	,bal_seg enum('VLOW','LOW','MED','HIGH','SUPER','0')  
##       			,max_bal decimal(16,2) unsigned
##       _BY_BALP_*/
...
## /*_BY_BAL_ , temp.orig_upb_pctile_BY_BAL_*/
## /*_D_BAL_ , temp.orig_upb_pctile_D_BAL_*/
## /*_BY_BALP_ , temp.orig_upb_pctile_BY_BALP_*/
## /*_D_BALP_ , temp.orig_upb_pctile_D_BALP_*/
, temp.bal_seg
