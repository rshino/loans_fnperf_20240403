...
params<-'TERM=360 VINT=2020 ELIG ST=NY BYAGE BY2HOM'
...
```
```{r}
cohortcf$totDQ<-cohortcf$X30DD.+cohortcf$X60DD.+cohortcf$X90.DD.

ggplot(cohortcf,aes(x=Loan.Age, y=totDQ
                     ,color=factor(Cohort.2nd.Home)))+
  geom_line()+
  ggtitle(paste0('30 Day+ Delinquency\n',params))+
  xlab("Loan Age (mo)")+
